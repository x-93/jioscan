...
import { JIO_UNIT } from "../explorer_constants";
                    ...
                    {[...tempBlocks]
                        ...
                        .slice(0, props.lines).map(x => {
                            ...
                            >
                                ...
                                <Link key={x.block_hash} to={`/txs/${x.txId}?blockHash=${x.blockHash}`} className="table-cell-link-styled">{numberWithCommas(x.amount / 100000000)}&nbsp;{JIO_UNIT}</Link>
