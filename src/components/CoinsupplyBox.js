...
import { getCoinSupply, getHalving } from '../jio-api-client';
import { API_SERVER, JIO_UNIT } from "../explorer_constants";
        ...
        <div className="cardBox mx-0">
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    ...
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} {JIO_UNIT}
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx">(approx.)</span></td>
                    <td className="pt-1">28,700,000,000 {JIO_UNIT}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{`${blockReward} ${JIO_UNIT}`}</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">
                        {halvingDate}<br />
                        <div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} {JIO_UNIT}</div>
                    </td>
                </tr>
            </table>
        </div>
