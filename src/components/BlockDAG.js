...
import { getBlockdagInfo, getFeeEstimate, getHashrate, getHashrateMax, getJiopadInfo } from '../jio-api-client';
import { numberWithCommas } from "../helper";
import { BPS, JIO_UNIT } from "../explorer_constants";
...
const BlockDAGBox = () => {
    ...
    const initBox = async () => {
        ...
        const jiopadInfo = await getJiopadInfo()
        ...
        // setMempool(jiopadInfo.mempoolSize)
        // localStorage.setItem("mempool", jiopadInfo.mempoolSize)
    }
            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    ...
                    <td className="pt-1 text-nowrap">
                        JIO {process.env.REACT_APP_NETWORK.toUpperCase()}
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement">
                ...
                <tr>
                    ...
                    <td className="pt-1" id="feerateReg">
                        ≈ {feerate > 300 ? (feerate * 3165 / 100000000).toFixed(2) : (feerate * 3165 / 100000000)} {JIO_UNIT}
                    </td>
                </tr>
            </table>
        </div>
