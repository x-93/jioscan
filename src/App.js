...
import { getBlock } from './jio-api-client';
import { ADDRESS_PREFIX, API_SERVER, JIO_UNIT, SOCKET_SERVER, SUFFIX } from "./explorer_constants";
                                ...
                                <Container id="navbar-container" fluid>
                                        ...
                                        <Navbar.Brand>
                                            <Link to="/">
                                                <div className="navbar-brand">
                                                    ...
                                                    <div
                                                        className="navbar-brand-text text-start">JIO<br />EXPLORER{SUFFIX}
                                                    </div>
                                                </div>
                                            </Link>
                                        </Navbar.Brand>
                                    ...
                                    <Navbar.Collapse id="responsive-navbar-nav">
                                        ...
                                        <div className='ms-auto navbar-price'>${price} <span
                                            className="text-light">/ {JIO_UNIT}</span></div>
                                    </Navbar.Collapse>
                                </Container>
                            </Navbar>
                        ...
                        <div className="text-light footerfull d-flex flex-row justify-content-center px-0">
                            <Container className="footer webpage px-sm-5 py-3 text-center madewith" fluid>
                                <Row className="d-none d-sm-block">
                                    <Col>
                                        Made with <font className="fs-5" color="red">♥</font> by Jio developers
                                        <span className="ms-3">
                                            <OverlayTrigger placement="left" overlay={<Tooltip id="github">Source code</Tooltip>}>
                                                <a className="blockinfo-link" href="https://github.com/lAmeR1/jio-explorer"
                                            ...
                                            <OverlayTrigger placement="right" overlay={<Tooltip id="donate">Donation address</Tooltip>}>
                                                <Link className="blockinfo-link ms-3"
                                                    to="/addresses/jio:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73"><BiDonateHeart
                                                        size="1.3rem" /></Link>
                                            </OverlayTrigger>
                                            <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                                                <a className="blockinfo-link ms-3" href="https://api.jio.org/" target="_blank"><SiFastapi
                                                    size="1.3rem" /></a>
                                            </OverlayTrigger>
                                        </span>
                                ...
                                <Row className="py-1 d-sm-none px-0">
                                    <Col>
                                        <span className="ms-2">
                                            ...
                                            <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                                                <a className="blockinfo-link ms-2" href="https://api.jio.org/" target="_blank"><SiFastapi
                                                    size="1.1rem" /></a>
                                            </OverlayTrigger>
                                        </span>
                                    </Col>
